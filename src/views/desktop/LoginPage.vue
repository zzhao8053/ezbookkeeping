            ...
            >
                ...
                <div class="d-flex align-center justify-center w-100 pt-10">
                    <v-img
                        class="img-with-direction"
                        max-width="600px"
                        src="img/desktop/people1.svg"
                        v-if="!isDarkMode"
                    />
                    <v-img
                        class="img-with-direction"
                        max-width="600px"
                        src="img/desktop/people1-dark.svg"
                    ...
                    >
                        <v-card-text>
                            ...
                            <p class="mb-0">
                                {{
                                    tt(
                                        "Please log in with your ezBookkeeping account"
                                    )
                                }}
                            </p>
    ...
    rootStore
        ...
        .catch((error) => {
            ...
            if (
                ...
                router.push(
                    `/verify_email?email=${encodeURIComponent(
                        error.error.context.email
                    )}&emailSent=${
