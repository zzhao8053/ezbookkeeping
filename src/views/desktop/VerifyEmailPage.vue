            ...
            >
                ...
                <div class="d-flex align-center justify-center w-100 pt-10">
                    <v-img
                        class="img-with-direction"
                        max-width="320px"
                        src="img/desktop/people2.svg"
                        v-if="!isDarkMode"
                    />
                    <v-img
                        class="img-with-direction"
                        max-width="320px"
                        src="img/desktop/people2-dark.svg"
                ...
                <div class="d-flex align-center justify-center h-100">
                    ...
                    >
                        <v-card-text>
                            ...
                            <p class="mb-0" v-if="token && loading">
                                {{ tt("Verifying...") }}
                            </p>
                            <p class="mb-0" v-if="token && verified">
                                {{ tt("Email address is verified") }}
                            </p>
                            <p
                                class="mb-0"
                                v-if="token && !verified && errorMessage"
                            >
                                {{ errorMessage }}
                            </p>
